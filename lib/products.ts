...
export const products: Product[] = [
  ...
  // Metabolic
  { name: "GLP3-R (Retatrutide)",   strengths: ["10mg", "30mg"], price: "$102.00 – $261.00", coa: "pending", category: "Metabolic" },
  ...
  { name: "GHK-Cu",                 strengths: ["50mg", "100mg"], price: "$45.00 – $61.50", coa: "pending", category: "Repair & Recovery" },
